...
def process():
    ...
    root_dir = "/home/bingbing/Documents/flowProSeg/interval_1"
    train_val = "val"
    ...
    adj_frame_file = "/media/data/bingbing/leftImg8bit_sequence/" + train_val + "_interval_1.lst"
    ...
    for i in xrange(len(flow_list)):
            ...
            id_path = os.path.join(cur_seg_dir, img_name+"IDBlack.png")
            color_path = os.path.join(cur_seg_dir, img_name+"ColorBlack.png")
